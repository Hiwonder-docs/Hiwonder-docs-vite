...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Hiwonder Docs","description":"Hiwonder documentation portal","base":"/projects/Hiwonder-docs/en/latest/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"siteTitle":false,"logo":"/e-logo.png","outline":[2,3],"search":{"provider":"local","options":{"translations":{"button":{"buttonText":"Search","buttonAriaLabel":"Search"},"modal":{"searchBox":{"resetButtonTitle":"Clear search query","resetButtonAriaLabel":"Clear search query","cancelButtonText":"Cancel","cancelButtonAriaLabel":"Cancel"},"startScreen":{"recentSearchTitle":"Recent Searches","noRecentSearchText":"No recent searches","suggestedQueryTitle":"Suggested Queries"},"noResultsScreen":{"noResultsText":"No results found for","suggestedQueryText":"You can try searching for","reportMissingResultsText":"Have any queries?","reportMissingResultsLinkText":"Report here"},"footer":{"selectText":"to select","navigateText":"to navigate","closeText":"to close"}}}}},"nav":[{"text":"Home","link":"https://wiki.hiwonder.com/","target":"_self"}],"sidebar":[{"text":"Raspberry Pi","link":"/docs/index.html#raspberry-pi","collapsed":false,"items":[{"text":"Robotics","link":"/docs/index.html#robotics"},{"text":"Board","link":"/docs/index.html#board"}]},{"text":"Jetson Series","link":"/docs/index.html#jetson-series","collapsed":false,"items":[{"text":"Robotics","link":"/docs/index.html#robotics-1"},{"text":"Board","link":"/docs/index.html#board-1"}]},{"text":"ESP32 & Arduino Series","link":"/docs/index.html#esp32-arduino-series","collapsed":false,"items":[{"text":"Robotics","link":"/docs/index.html#robotics-2"}]},{"text":"microbit Series","link":"/docs/index.html#microbit-series","collapsed":false,"items":[{"text":"Robotics","link":"/docs/index.html#robotics-3"}]},{"text":"Scratch Series","link":"/docs/index.html#scratch-series","collapsed":false,"items":[{"text":"Robotics","link":"/docs/index.html#robotics-4"}]},{"text":"Controller","link":"/docs/index.html#controller","collapsed":false,"items":[{"text":"ROS Controller","link":"/docs/index.html#ros-controller"},{"text":"Servo Controller","link":"/docs/index.html#servo-controller"}]},{"text":"Accessories","link":"/docs/index.html#accessories","collapsed":false,"items":[{"text":"Vehicle Chassis","link":"/docs/index.html#vehicle-chassis"},{"text":"Camera/Lidar","link":"/docs/index.html#camera-lidar"},{"text":"Sensor","link":"/docs/index.html#sensor"}]}]},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
function pathToFile(path) {
  ...
  {
    if (inBrowser) {
      const base = "/projects/Hiwonder-docs/en/latest/";
...
const _sfc_main$v = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.D23nkuFe.js"));
